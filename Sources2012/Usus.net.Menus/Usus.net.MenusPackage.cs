	...
	public sealed class Usus_net_MenusPackage : Package
	{
		...
		protected override void Initialize()
		{
			...
			if (null != mcs)
			{
				...
				SetupCommand(mcs, PkgCmdIDList.cmdidUsusNetTypeCycles, MenuItemCallback_TypeCycles);
			}
		}
		...
		private void MenuItemCallback_TypeCycles(object sender, EventArgs e)
		{
			UsusNetWindow.Open(_Shell, UsusNetWindow.TypeCycles);
		}
	}
}
